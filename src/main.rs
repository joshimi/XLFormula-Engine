...
fn main() -> Result<(), ParseError> {
    ...
    let formula =
        parse_formula::parse_string_to_formula(r#"=1 + "Hello""#, None::<NoCustomFunction>); // error (#CAST!)
    let result = calculate::calculate_formula(formula, None::<NoReference>);
    println!("Result is {}", calculate::result_to_string(result));
    ...
    let formula =
        parse_formula::parse_string_to_formula(r#"=SUM(1,2,"3")"#, None::<NoCustomFunction>);
    let result = calculate::calculate_formula(formula, None::<NoReference>);
    println!("Result is {}", calculate::result_to_string(result));
    ...
    let formula =
        parse_formula::parse_string_to_formula("=AVERAGE({1,2,3},1,2,3)", None::<NoCustomFunction>);
    let result = calculate::calculate_formula(formula, None::<NoReference>);
    println!("Result is {}", calculate::result_to_string(result));
    ...
    ///////////// RIGHT function
    let formula =
        parse_formula::parse_string_to_formula(r#"=RIGHT("apple", 3)"#, None::<NoCustomFunction>);
    let result = calculate::calculate_formula(formula, None::<NoReference>);
    println!("Result is {}", calculate::result_to_string(result));

    let formula =
        parse_formula::parse_string_to_formula(r#"=RIGHT("apple")"#, None::<NoCustomFunction>);
    let result = calculate::calculate_formula(formula, None::<NoReference>);
    println!("Result is {}", calculate::result_to_string(result));
    ...
    ///////////// LEFT function
    let formula =
        parse_formula::parse_string_to_formula(r#"=LEFT("apple", 3)"#, None::<NoCustomFunction>);
    let result = calculate::calculate_formula(formula, None::<NoReference>);
    println!("Result is {}", calculate::result_to_string(result));

    let formula =
        parse_formula::parse_string_to_formula(r#"=LEFT("apple")"#, None::<NoCustomFunction>);
    let result = calculate::calculate_formula(formula, None::<NoReference>);
    println!("Result is {}", calculate::result_to_string(result));
    ...
    let formula =
        parse_formula::parse_string_to_formula("=ISBLANK(ReferenceKey)", None::<NoCustomFunction>);
    let result = calculate::calculate_formula(formula, Some(&data_function));
    println!("Result is {}", calculate::result_to_string(result));

    let formula =
        parse_formula::parse_string_to_formula("=ISBLANK(ReferenceName)", None::<NoCustomFunction>);
    let result = calculate::calculate_formula(formula, Some(&data_function));
    println!("Result is {}", calculate::result_to_string(result));
